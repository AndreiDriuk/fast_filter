...
const int input_size          // Размер входного массива
    ...
    output[2*gid] = input_1[2*gid]*input_2[2*gid]-input_1[2*gid+1]*input_2[2*gid+1];
    output[2*gid+1] = input_1[2*gid]*input_2[2*gid+1]+input_1[2*gid+1]*input_2[2*gid];
}